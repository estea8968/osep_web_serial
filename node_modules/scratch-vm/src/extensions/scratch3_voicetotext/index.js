...
class voicetoTEXT {
    constructor(runtime) {
        ...
        // 設定語音辨識功能為 false，表示尚未啟用
        this.speechStarts = false;
    }
    ...
    beginVoice() {
        v_textArray[0] = "";
        if (this.speechStarts == false) {
            recognition.start();
            this.speechStarts = true; 
        }
    }

    pauseVoice() {
        if (this.speechStarts == true) {
            recognition.abort();
            this.speechStarts = false;
        }
    }
    ...
    nullTEXT() {
        return this.v_text.data = v_textArray[0] = "";
    }
