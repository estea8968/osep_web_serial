...
class openai {
    ...
    async talktext(args){
        ...
        const wait_time = parseInt(args.Timer,10)*1000;
        ...
        try {
            ...
            return_text = completion.data.choices[0].text;
            console.log('aaa=',completion.data.choices[0].text);
            console.log('bbb=',completion.data);
          } catch (error) {
            if (error.response) {
