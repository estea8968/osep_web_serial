...
const ContentPort = {
    'en': 'Connect mqtt server [URL],username:[USR] password:[PWS]',
    'zh-tw': '連線到mqtt server [URL] 使用者:[USR] 密碼:[PWS]',
};
const Content_off ={
    'en': 'Connect close',
    'zh-tw': '終斷連線',
...
//mqtt message
let mqtt_message = disconnect[the_locale];
let client = {};
let clientId ;
...
class Scratch3Mqtt {
    ...
    async connect_off(args){
        mqtt_message = disconnect[the_locale];
        client.end();
        client = {};
    }
    ...
    async connect_mqtt(args) {
        ...
        client.on('error', function (err) {
          ...
          client.on('connect', function () {
            ...
            mqtt_message = isconnect[the_locale];
