...
class Scratch3LineNotify {
    ...
    async sendmessage(args){
        ...
        console.log(this.user_token);
        const exec='https://script.google.com/macros/s/AKfycbyqdDGWR6UKkduggANLyFTCGcUYDGrvUS7l-4mG59fKXMoHYcm_mOsORKOQSGL0mw/exec';
        let a = { 
            token: this.user_token,
            message: args_message,
        }
        //console.log(`${exec}?${a}`);
        jqueryMin.post(exec,a);
        token ='';
    }   
