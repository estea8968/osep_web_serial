        ...
        console.log(return_txt);
          ...
          if(sp_ary[0]=='A' || sp_ary[0]=='D'){
            switch (send_value) {
                case 0:
                    //搖桿 lastDataSample[7]
                    lastDataSample[7]= Number(sp_ary[1]);
                    break;
                case 1:
                    //J4 A1 lastDataSample[0]
                    lastDataSample[0]= Number(sp_ary[1]);
                    break;
                case 2:
                    //J3 A2 lastDataSample[0]
                    lastDataSample[1]= Number(sp_ary[1]);
                    break;            
                case 3:
                    //聲音
                    lastDataSample[6]= Number(sp_ary[1]);
                    break;
                case 4:
                    //J2 A4 lastDataSample[0]
                    lastDataSample[2]= Number(sp_ary[1]);
                    break;    
                case 5:
                    //J1 A5 lastDataSample[0]
                    lastDataSample[4]= Number(sp_ary[1]);
                    break;        
                case 6:
                    //光敏A6 lastDataSample[5]
                    lastDataSample[5]=Number(sp_ary[1]);
                    break; 
                case 7:
                    //按鈕 d2 lastDataSample[3]
                    lastDataSample[3]=Number(sp_ary[1]);
                    break;                        
            }
