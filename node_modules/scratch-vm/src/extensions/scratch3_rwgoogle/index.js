...
class rwGoogle {
    ...
    async readGoogleSheetCol_1(args) {
        ...
        if (this.googleSheetURL_1 != "" && this.googleSheetTAG_1 != "") {
            ...
            //const exec = `https://script.google.com/macros/s/AKfycbyhYlrxfY61sCOKMC8G6G0XHmyh1_kjFYAP8N0yMFs0HlH7pjC4Zm8d3VALbLGAsgj7rQ/exec`;
    ...
    async readGoogleSheet_json(args) {
        ...
        if (this.googleSheetURL_1 != "" && this.googleSheetTAG_1 != "") {
            ...
            //const exec =`https://script.google.com/macros/s/AKfycbzBZXaA2Gf9-6gW0Whm-zbczf0bs6dIAk0FMyCpi7xItwMVyRRdD3koKRtZmoSeNg_MHQ/exec`;
            const exec =`https://script.google.com/macros/s/AKfycbwes_oXmBMZ9I-QVK_nzG5V2jxqVGuOFxFvMrX8frqXyu7JANH9jyuSqJo-U5kD75_LEg/exec`;
