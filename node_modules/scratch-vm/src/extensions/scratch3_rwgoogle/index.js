...
class rwGoogle {
    ...
    async googleJSON (args) {
        ...
        const aurl ='https://docs.google.com/spreadsheets/d/'+urlsplit[5]+'/export?format=csv';
        const csv_data =await fetch(aurl,{method:'get'}).then(response => response.text());
    ...
    var get_url = window.open(gurl,'_blank');
	console.log(gurl);
	fetch(gurl).then(res => {
	    if (res.ok) {
	    }
