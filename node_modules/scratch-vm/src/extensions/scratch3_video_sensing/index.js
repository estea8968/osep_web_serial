...
class Scratch3VideoSensingBlocks {
                ...
                },
                {
                    ...
                    arguments: {
                        WEBCAM: {
                            ...
                            defaultValue: this.get_ue_cam()[0]
                        }
                    }
                },
                {
    ...
    get_ue_cam(){
        const uecam =formatMessage({id:'videoSensing.u_or_e'}).split(',');
        console.log('uecam0=',uecam);
        return uecam; 
    }
    /**
     ...
     */
    videoOn (args, util) {
        //console.log('video device=',this.runtime.ioDevices.video.provider._track.label);
    ...
    async ue_cam(args){
        ...
        const ue_webcam = this.get_ue_cam();
