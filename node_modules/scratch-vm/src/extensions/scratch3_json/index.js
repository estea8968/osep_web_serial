...
class gasoJSON {
    ...
    async fetchJSON(args) {
        ...
        return await fetch(cors_url +'?url='+ url).then(res => {
            ...
            xmlhttpRequest.open("GET", `${cors_url}?url=encodeURI(${url})`);
            xmlhttpRequest.setRequestHeader(
                "X-Requested-With",
                "XMLHttpRequest"
            );
            xmlhttpRequest.send();
	    console.log(cors_url +'?url='+ encodeURI(url));
            fetch(cors_url +'?url='+ encodeURI(url)).then((res) => {
                if (res.ok) {
                    res.json().then((json) => {
                        this.data.fetched = true;
                        this.data.data = JSON.stringify(json);
