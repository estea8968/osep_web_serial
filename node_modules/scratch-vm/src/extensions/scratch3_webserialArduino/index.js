...
const FormWs2812SetPin ={
    'en': "Led array on pin:[PIN] color:[RGB]",
    'zh-tw': "設定Led陣列在腳位[PIN] 顏色:[RGB]",
};
const FormWs2812SetNum = {
    'en': 'Led array light[NUM],value:[VALUE]',
    'zh-tw': 'led陣列，亮第[NUM]顆，值:[VALUE]',
};
...
class Scratch3ArduinoWebSerial {
    ...
    ws2812_set_num(args){
        ...
        send_color_data = send_color_data +led_num+','+led_value+',';
