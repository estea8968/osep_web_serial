...
export const FormMax7219Set = {
    'en': "max7219 set data pin:[DATA_PIN] clock pin[CLK_PIN] cs pin[CS_PIN] devices[DEVICES]",
    'zh-tw': "max7219設定  data 腳位[DATA_PIN] clock 腳位[CLK_PIN] cs 腳位[CS_PIN] 片數[DEVICES]"
}
...
export const Form7219_matrix ={
    'en': "01show value:[VALUE]",
    'zh-tw':"顯示01值[VALUE]"
}